...
<main class="ui container two column stackable grid">
  ...
  <div class="apc-main twelve wide column">
    <div class="ui site-slider banner" id="thumbnail">
      <ul>
        <li><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/silder/banner-1.jpg"></li>
        <li><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/silder/banner-2.jpg"></li>
      </ul>
    </div>
    <div class="ui site-index-hot-articles">
      ...
      <div class="browse-more-btn" style="display:none;">
        <a href="more.html">
    ...
    <div class="ui site-more-articles" style="display:none;">
